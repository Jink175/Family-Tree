      ...
      {DocsNav.map((item) => {
        return (
          <Link
            ...
            className={`py-2.5 hover:bg-[#a2e8bc]/20 hover:text-[#2D6A4F] dark:hover:text-[#2D6A4F] xl:min-w-60 lg:min-w-52 min-w-full px-4 rounded-md text-base font-medium  ${item.hash === navItem
                ? 'bg-[#a2e8bc] text-black '
                : 'text-muted/60'
              }`}>
            {item.navItem}
          </Link>
